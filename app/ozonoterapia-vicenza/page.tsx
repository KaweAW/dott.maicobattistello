...
export default function OzonoterapiaVicenzaPage() {
  return (
    <div className="pt-20">
      {/* Breadcrumb */}
      <Breadcrumb
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose max-w-none">
          ...
          <p className="text-lg mb-6">
            ...
            <strong>rigenerazione dei tessuti</strong>. A <strong>Vicenza</strong>, il Dr. Maico Battistello offre
            questi trattamenti presso strutture qualificate nella provincia di <strong>VI</strong>. Per queste
